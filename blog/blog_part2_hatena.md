...
という質問に、ChatGPTはなんとスラスラと**架空の材料**について、あたかも実在するかのように、それも**自信満々**に！ウソを書き連ねてきました。
...
そんな疑問に迫りつつ、**ハルシネーション（…AIの“創話癖”）とどう向き合えばいいか**を一緒に考えていきましょう！
...
ただしその文章全てを丸暗記しているわけではありません。その文章で言葉と言葉の「つながりのパターン」みたいなもの[^3]を、学習しています。「この言葉の次は、次はこの言葉が来がちだよね」って感じで、文章丸暗記ではなく、雰囲気を学んでいます。
丸暗記ではないので、学んだ文章の中にない言葉でも、「つながりのパターン」を予測してもっともらしい文章を作ってくれるんですね。応用が効く。  

しかしそれは言い換えるとこの世界の事実と矛盾する文章も作ってしまう可能性があるということなんです。だって、世の中、パターン通りの文章ばかりじゃないですよね、「一、二、三ときて、なんで次は四なんだ**Whyyyyyy Japanese peopleeeeeeeeeeeee！！！！！**」って厚切りジェイソンも言ってました。実際に、学んだパターン通りの文章は、逆に違和感があることがわかっています。

だから、例の「ナノ・オーラル合金」みたいに、この世に存在しないことを聞かれても、「知りません」とは言わない。わざわざ未知の単語についてこの単語は知りません。と述べている自然な文脈が少ないからです。AIはそのように学習していない。その代わり、「うーん、ナノレベルの技術が使われている歯科合金ということは…こんな物性があるんですかね！」ってなノリで、それっぽい単語を並べて、矛盾がないように見える見栄えのいい文章を作ってしまいます。なぜならそう訓練されているから。

これがうまくいくパターンもあります、例えば空想のお話なんかでは、白いカラスの話でもしてくれる

これって、人間でいう「ウソ」とはちょっと違って、AIなりの誠実な（？）予測の結果なんですよね。知識を検索してるんじゃなくて、あくまで“それっぽい”言葉のつながりを
紡いでいるだけ。巷で噂されてる「ハルシネーションはしないでください。」というプロンプトは効果があまりないことがわかります。だって常にAIは全力で次の単語を予想してるんですから。
⸻
